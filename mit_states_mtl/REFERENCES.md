...
|---|---|---|---|---|---|---|---|
| 实验1（我们） | ResNet MTL | ResNet50 | ~35%* | ~0% | ~0 | — | 闭集 joint_acc，不可直接比 |
| 实验2（我们） | CLIP 零样本 | ViT-B/16 | 28.2 | 41.1 | 23.6 | 8.97 | 无训练下界 |
| 实验3（我们） | CSP 复现 | ViT-B/16 | **43.0** | **46.3** | **33.0** | **16.25** | 骨干降级版，超 CoOp(13.5) |
| CLIP 零样本 官方 | 无训练 | ViT-L/14 | 30.2 | 46.0 | 26.1 | 11.0 | 参考点 |
...
| 实验4（我们） | YOLOv8m 微调 | **60.6** | 低于论文 baseline |
| 实验5（我们） | DINOv2 冻结 MTL | **55.3** | 低于 baseline |
